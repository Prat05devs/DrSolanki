...
export default function ConditionsSection() {
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl w-full py-10 sm:py-12 md:py-14 lg:py-16">
        <div className="text-center mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-[var(--font-playfair)] font-black text-[#2D2A26] mb-3 sm:mb-4 leading-[1.15] tracking-[-0.01em]">
            Specialized Care for Complex Conditions
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-[#2D2A26]/60 max-w-2xl mx-auto leading-[1.7] px-4">
        ...
        <div className="grid md:grid-cols-3 gap-5 sm:gap-6 md:gap-7 lg:gap-8 mb-8 sm:mb-10 md:mb-12">
          {conditions.map((condition, idx) => (
            ...
            >
              <Link href={condition.link} className="group block h-full p-5 sm:p-6 md:p-7 lg:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-white to-[#E4EFE9]/20 border border-[#2D2A26]/5 hover:border-[#C07766]/30 hover:shadow-xl transition-all">
                <h3 className="text-xl sm:text-2xl font-[var(--font-playfair)] font-bold text-[#2D2A26] mb-2 group-hover:text-[#C07766] transition-colors leading-[1.15] tracking-[-0.01em]">
                  {condition.name}
                </h3>
                <p className="text-sm sm:text-base text-[#2D2A26]/70 mb-3 sm:mb-4 leading-[1.7]">
                  {condition.description}
                </p>
                
                <div className="space-y-1.5 mb-4 sm:mb-5">
                  <p className="text-sm font-semibold text-[#2D2A26]/80 mb-1.5">Common Symptoms:</p>
