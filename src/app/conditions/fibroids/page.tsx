          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-[#2D2A26]/70 max-w-2xl mx-auto">
                Non-cancerous growths in the uterus that can cause heavy bleeding, pelvic pain, and impact fertility.
              </p>
            </div>

            <div className="bg-white rounded-2xl p-8 border border-[#2D2A26]/5 shadow-sm mb-8">
              <h2 className="text-2xl font-bold text-[#2D2A26] mb-4">Treatment Options</h2>
              <p className="text-[#2D2A26]/70 mb-6">
                Dr. Smit Bharat Solanki specializes in robotic myomectomy, a minimally invasive procedure 
                to remove fibroids while preserving your uterus and fertility.
              </p>
              <Link
